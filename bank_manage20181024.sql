...
CREATE TABLE `user_apply_archive` (
  ...
  `first_name` varchar(255) NOT NULL,
  `last_name` varchar(255) NOT NULL,
  `identity_id` varchar(50) NOT NULL COMMENT 'passport/license id number',
  `identity_id_type` int(11) NOT NULL COMMENT '1.passport 2.driver license',
...
-- Dump completed on 2018-10-24 16:19:30
